...
Response.prototype.relationship = function (resource) {
  return new Relationship(this.base, resource);
};
...
Response.prototype.include = function (resource) {
  this._included.add(resource);
  return this;
};
...
Response.prototype.toObject = function () {
  return utils.filter({
    ...
    included: this._included.toObject()
  });
};
